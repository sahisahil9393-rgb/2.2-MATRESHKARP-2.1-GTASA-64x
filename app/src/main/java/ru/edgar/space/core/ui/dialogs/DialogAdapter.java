...
import ru.edgar.space.core.views.MaskedEditText;
...
public class DialogAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.dialog_item_old, parent, false));
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            this.mView = itemView;
            this.mFieldBg = (ImageView) itemView.findViewById(R.id.item_bg);
            LinearLayout field = itemView.findViewById(R.id.dialog_item_main);
