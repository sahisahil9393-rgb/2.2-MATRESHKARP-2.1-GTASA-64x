...
void DialogBox(RPCParameters *rpcParams)
{
	...
	if (pUI) 
	{
		...
		pJavaWrapper->MakeDialog(byteDialogStyle, wDialogID, (char*)Encoding::cp2utf(szTitle).c_str(), (char*) Encoding::cp2utf(szMessage).c_str(), (char*) Encoding::cp2utf(szButton1).c_str(), (char*) Encoding::cp2utf(szButton2).c_str());
	}
