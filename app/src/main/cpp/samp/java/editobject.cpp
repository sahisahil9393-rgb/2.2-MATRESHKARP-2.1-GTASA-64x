...
Java_ru_edgar_space_ui_AttachEdit_Exit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ru_edgar_space_ui_AttachEdit_AttachClick(JNIEnv *env, jobject thiz, jint button_type,
                                                  jboolean button_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ru_edgar_space_ui_AttachEdit_Save(JNIEnv *env, jobject thiz) {
    CPlayerPed* pPlayer = pNetGame->GetPlayerPool()->GetLocalPlayer()->GetPlayerPed();
    int slot = CObjectEditor::iEditedId;
    auto attach = pPlayer->GetAttachedObject(slot);
