...
bool CGame::InitialiseRenderWare() {
    ...
    // radar
    TextureDatabase* radar = TextureDatabaseRuntime::Load("radar", false, TextureDatabaseFormat::DF_DXT);
    CHook::CallFunction<void>(g_libGTASA + (VER_x32 ? 0x1E9B48 + 1 : 0x2865D8), radar);
    //TextureDatabaseRuntime::Load("cutscene", false, TextureDatabaseFormat::DF_Default);
...
VEHICLEID CGame::getSampId(CVehicleGTA* m)
{
	return pNetGame->GetVehiclePool()->FindIDFromGtaPtr(m);
}
